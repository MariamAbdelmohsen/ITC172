...
namespace FinalProject2.Controllers
{
    public class DonationsController : Controller
    {
        ...
        {
            var donations = db.Donations.Include(d => d.Person);
        ...
        public ActionResult Create([Bind(Include = "DonationKey,PersonKey,DonationDate,DonationAmount,DonationConfirmation")] Donation donation)
        {
